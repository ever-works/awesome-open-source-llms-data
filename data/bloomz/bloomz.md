...
**Architecture**: Same as BLOOM (decoder-only transformer)
**Context Length**: Standard for BLOOM
**Fine-Tuning**: xP3 dataset instruction-tuning
**Inference**: Standard transformer inference
