...
Ministral 14B Reasoning, from Mistral AI, is a breakthrough in compact reasoning models. With only 14 billion parameters, it achieves reasoning performance that rivals models 5-10 times its size.

## Architecture

The model employs a dense transformer architecture with specialized reasoning training. It achieves efficiency through careful dataset curation and reinforcement learning focused specifically on mathematical and logical reasoning tasks.

## Performance

- Approximately 85% accuracy on AIME 2025
- 68.2% on GPQA Diamond
- 82.7% on MATH-500
- 78.5% on HumanEval
